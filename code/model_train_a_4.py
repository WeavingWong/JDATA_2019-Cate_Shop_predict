...
def make_train_set():
    filePath = '../data/features/features_a_4/trainSet.csv'
    if os.path.exists(filePath):
        trainSet = pd.read_csv(filePath)
    else:
        trainSet = pd.read_csv('../data/features/features_a_4/train_label_a_4.csv')

        ##--------------------------------------------------
        ##   此特征： 加入用户基本信息特征
        #         userInfo = get_userInfo_feat()
        userInfo = pd.read_csv('../data/features/features_a_4/user_features.csv')
        ...
        ucs_features = pd.read_csv('../data/features/features_a_4/ucs_features.csv')
        ...
        cateInfo = pd.read_csv('../data/features/features_a_4/cate_features.csv')
        ...
        shopInfo = pd.read_csv('../data/features/features_a_4/shop_features.csv')
        ...
        user_cate_info = pd.read_csv('../data/features/features_a_4/user_cate_features.csv')
        ...
        user_shop_info = pd.read_csv('../data/features/features_a_4/user_shop_features.csv')
        ...
        cate_shop_info = pd.read_csv('../data/features/features_a_4/cate_shop_features.csv')
        trainSet = pd.merge(trainSet, cate_shop_info, how='left', on=['cate', 'shop_id'])
        del cate_shop_info

        trainSet.to_csv('../data/features/features_a_4/trainSet.csv', index=False, encoding='utf-8')
        print('OK!')
    return trainSet


def make_test_set():
    filePath = '../data/features/features_a_test/testSet.csv'
    if os.path.exists(filePath):
        testSet = pd.read_csv(filePath)
    else:
        testSet = pd.read_csv('../data/features/features_a_test/test_index.csv')

        ##--------------------------------------------------
        ##   此特征： 加入用户基本信息特征
        #         userInfo = get_userInfo_feat()
        userInfo = pd.read_csv('../data/features/features_a_test/user_features.csv')
        ...
        ##   此特征： 加入用户-品类-店铺信息特征
        #         userInfo = get_ucs_feat()
        ucs_features = pd.read_csv('../data/features/features_a_test/ucs_features.csv')
        ...
        ##   此特征： 加入品类的基本信息特征，体现品类自身的热度和热门度
        #         cateInfo = get_cateInfo_feat()
        cateInfo = pd.read_csv('../data/features/features_a_test/cate_features.csv')
        ...
        ##   此特征： 加入店铺的信息特征，体现店铺自身的热度和热门度
        #         shopInfo = get_shopInfo_feat()
        shopInfo = pd.read_csv('../data/features/features_a_test/shop_features.csv')
        ...
        ##   此特征： 加入用户-品类的信息特征，体现用户对品类的喜爱度
        #         user_cate_info = get_user_cate_feat()
        user_cate_info = pd.read_csv('../data/features/features_a_test/user_cate_features.csv')
        ...
        ##   此特征： 加入用户-店铺的信息特征，体现用户对店铺的喜爱度
        #         user_shop_info = get_user_shop_feat()
        user_shop_info = pd.read_csv('../data/features/features_a_test/user_shop_features.csv')
        ...
        ##   此特征： 加入品类-店铺的信息特征，体现用户对品类-店铺的喜爱度
        #         cate_shop_info = get_cate_shop_feat()
        cate_shop_info = pd.read_csv('../data/features/features_a_test/cate_shop_features.csv')
        testSet = pd.merge(testSet, cate_shop_info, how='left', on=['cate', 'shop_id'])
        del cate_shop_info

        testSet.to_csv('../data/features/features_a_test/testSet.csv', index=False, encoding='utf-8')
        print('OK!')
    return testSet
...
if __name__ == '__main__':
    ...
    # (2)模型4的训练
    dataSet = pd.read_csv('../data/features/features_a_4/trainSet.csv')
    x_test = pd.read_csv('../data/features/features_a_test/testSet.csv')
    ...
    # 保存模型
    joblib.dump(bst, '../data/output/model/model_a_4.pkl')
    del dataSet, dtrain
    ...
    feature_importances.to_csv('../data/output/feature_importance/feature_importance_a_4.csv', index=False, encoding='utf-8')
    ...
    test_set = pd.read_csv('../data/features/features_a_test/test_index.csv')
    predict = pd.concat([test_set, predict], axis=1)
    predict.to_csv('../data/output/predict/prediction_a_4.csv', index=False, encoding='utf-8')
    
    print('The fourth model_train is OK!!!')
