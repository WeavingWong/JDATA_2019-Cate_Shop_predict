...
def make_train_set():
    filePath = '../data/features/features_3_4/trainSet.csv'
    if os.path.exists(filePath):
        trainSet = pd.read_csv(filePath)
    else:
        trainSet = pd.read_csv('../data/features/features_3_4/train_label_3_4.csv')

        ##--------------------------------------------------
        ##   此特征： 加入用户基本信息特征
        #         userInfo = get_userInfo_feat()
        userInfo = pd.read_csv('../data/features/features_3_4/user_features.csv')
        ...
        ucs_features = pd.read_csv('../data/features/features_3_4/ucs_features.csv')
        ...
        cateInfo = pd.read_csv('../data/features/features_3_4/cate_features.csv')
        ...
        shopInfo = pd.read_csv('../data/features/features_3_4/shop_features.csv')
        ...
        user_cate_info = pd.read_csv('../data/features/features_3_4/user_cate_features.csv')
        ...
        user_shop_info = pd.read_csv('../data/features/features_3_4/user_shop_features.csv')
        ...
        cate_shop_info = pd.read_csv('../data/features/features_3_4/cate_shop_features.csv')
        trainSet = pd.merge(trainSet, cate_shop_info, how='left', on=['cate', 'shop_id'])
        del cate_shop_info

        trainSet.to_csv('../data/features/features_3_4/trainSet.csv', index=False, encoding='utf-8')
        print('OK!')
    return trainSet
...
if __name__ == '__main__':
    ...
    # 保存模型
    joblib.dump(bst, '../data/output/model/model_3_4.pkl')
    del dataSet, dtrain
    ...
    feature_importances.to_csv('../data/output/feature_importance/feature_importance_3_4.csv', index=False, encoding='utf-8')
    ...
    predict.to_csv('../data/output/predict/prediction_3_4.csv', index=False, encoding='utf-8')
    
    print('The Third model_train is OK!!!')
