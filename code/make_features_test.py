...
def get_user_features():
    ...
    # (1)统计个人信息
    Path = '../data/features/features_test/userInfo.csv'
    if os.path.exists(Path):
        ...
        # userInfo.to_csv('../data/features/features_test/userInfo.csv', index=False, encoding='utf-8')
    user_features = pd.merge(user_features, userInfo, on='user_id', how='left').fillna(0)
    print('userInfo')

    # (2)统计用户的购买频次，用户的平均购买时间间隔, 最后一次购买距离考察周时间
    Path = '../data/features/features_test/user_buy_info.csv'
    if os.path.exists(Path):
        ...
        # userSub.to_csv('../data/features/features_test/user_buy_info.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/u_n_counts.csv'
    if os.path.exists(Path):
        ...
        # u_n_counts.to_csv('../data/features/features_test/u_n_counts.csv', index=False, encoding='utf-8')
    user_features = pd.merge(user_features, u_n_counts, on='user_id', how='left').fillna(0)
    print('u_n_counts')
    user_features.to_csv('../data/features/features_test/user_features.csv', index=False, encoding='utf-8')
    print('user_features!!!!')
...
def get_ucs_features():
    ...
    Path = '../data/features/features_test/ucs_b_rate.csv'
    if os.path.exists(Path):
        ...
        # ucs_b_rate.to_csv('../data/features/features_test/ucs_b_rate.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/ucs_b_count_in_n.csv'
    if os.path.exists(Path):
        ...
        # ucs_b_count_in_n.to_csv('../data/features/features_test/ucs_b_count_in_n.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/ucs_bi_count_in_n.csv'
    if os.path.exists(Path):
        ...
        ucs_bi_count_in_n = pd.merge(ucs_bi_count_in_n, ucs_bi_count_in_1, on=['user_id', 'cate', 'shop_id'],
                                     how='left').fillna(0)
        # ucs_bi_count_in_n.to_csv('../data/features/features_test/ucs_bi_count_in_n.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/ucs_b2_diff_day.csv'
    if os.path.exists(Path):
        ...
        # ucs_b2_diff_day.to_csv('../data/features/features_test/ucs_b2_diff_day.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/ucs_b1_last_day.csv'
    if os.path.exists(Path):
        ...
        # usertmp.to_csv('../data/features/features_test/ucs_b1_last_day.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/ucs_active_days.csv'
    if os.path.exists(Path):
        ...
        # ucs_active_days.to_csv('../data/features/features_test/ucs_active_days.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/ucs_b_count_rank_in_n_in_u.csv'
    if os.path.exists(Path):
        ...
        # ucs_b_count_rank_in_n_in_u.to_csv('../data/features/features_test/ucs_b_count_rank_in_n_in_u.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/ucs_buy_info.csv'
    if os.path.exists(Path):
        ...
        userSub = userSub.merge(usertmp, on=['user_id', 'shop_id', 'cate'], how='left')
        userSub.drop(['type_2', 'action_time'], axis=1, inplace=True)
        # userSub.to_csv('../data/features/features_test/ucs_buy_info.csv', index=False, encoding='utf-8')
    ...
    filePath = '../data/features/features_test/ucs_features.csv'
...
def get_cateInfo_features():
    ...
    Path = '../data/features/features_test/c_b2_rate.csv'
    if os.path.exists(Path):
        ...
        # c_b2_rate.to_csv('../data/features/features_test/c_b2_rate.csv', index=False, encoding='utf-8')
    cate_features = pd.merge(cate_features, c_b2_rate, on='cate', how='left').fillna(0)
    print('c_b2_rate')

    # (2)c_all_count(品类下商品，品牌，店铺的数量)
    Path = '../data/features/features_test/c_all_count.csv'
    if os.path.exists(Path):
        ...
        # c_all_count.to_csv('../data/features/features_test/c_all_count.csv', index=False, encoding='utf-8')
    cate_features = pd.merge(cate_features, c_all_count, on='cate', how='left').fillna(0)
    print('c_all_count')

    # (3)c_new_item_count(品类下新品的数量)
    Path = '../data/features/features_test/c_new_item_count.csv'
    if os.path.exists(Path):
        ...
        # c_new_item_count.to_csv('../data/features/features_test/c_new_item_count.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/c_u_count_in_n.csv'
    if os.path.exists(Path):
        ...
        # c_u_count_in_n.to_csv('../data/features/features_test/c_u_count_in_n.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/c_bi_count_in_n.csv'
    if os.path.exists(Path):
        ...
        # c_bi_count_in_n.to_csv('../data/features/features_test/c_bi_count_in_n.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/c_b_count_in_n.csv'
    if os.path.exists(Path):
        ...
        # c_b_count_in_n.to_csv('../data/features/features_test/c_b_count_in_n.csv', index=False, encoding='utf-8')
    cate_features = pd.merge(cate_features, c_b_count_in_n, on='cate', how='left').fillna(0)
    print('c_b_count_in_n')

    # (7)c_b2_count(类别被购买的频次)
    Path = '../data/features/features_test/c_b2_count.csv'
    if os.path.exists(Path):
        ...
        # c_b2_count.to_csv('../data/features/features_test/c_b2_count.csv', index=False, encoding='utf-8')
    cate_features = pd.merge(cate_features, c_b2_count, on='cate', how='left').fillna(0)
    print('c_b2_count')

    # (8)品类的评论
    Path = '../data/features/features_test/c_comments_counts.csv'
    if os.path.exists(Path):
        ...
        userSub.rename(
            ...
            inplace=True)
        # userSub.to_csv('../data/features/features_test/c_comments_counts.csv', index=False, encoding='utf-8')
    ...
    filePath = '../data/features/features_test/cate_features.csv'
...
def get_shopInfo_features():
    ...
    Path = '../data/features/features_test/s_b2_rate.csv'
    if os.path.exists(Path):
        ...
        # s_b2_rate.to_csv('../data/features/features_test/s_b2_rate.csv', index=False, encoding='utf-8')
    shop_features = pd.merge(shop_features, s_b2_rate, on='shop_id', how='left').fillna(0)
    print('s_b2_rate')

    # (2)s_all_count(店铺下品类,商品的个数)
    Path = '../data/features/features_test/s_all_count.csv'
    if os.path.exists(Path):
        ...
        # s_all_count.to_csv('../data/features/features_test/s_all_count.csv', index=False, encoding='utf-8')
    shop_features = pd.merge(shop_features, s_all_count, on='shop_id', how='left').fillna(0)
    print('s_all_count')

    # (3)s_new_item_count(店铺下新品的数量)
    Path = '../data/features/features_test/s_new_item_count.csv'
    if os.path.exists(Path):
        ...
        # s_new_item_count.to_csv('../data/features/features_test/s_new_item_count.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/s_u_count_in_n.csv'
    if os.path.exists(Path):
        ...
        # s_u_count_in_n.to_csv('../data/features/features_test/s_u_count_in_n.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/s_bi_count_in_n.csv'
    if os.path.exists(Path):
        ...
        # s_bi_count_in_n.to_csv('../data/features/features_test/s_bi_count_in_n.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/s_b_count_in_n.csv'
    if os.path.exists(Path):
        ...
        # s_b_count_in_n.to_csv('../data/features/features_test/s_b_count_in_n.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/s_b2_diff_day.csv'
    if os.path.exists(Path):
        ...
        # s_b2_diff_day.to_csv('../data/features/features_test/s_b2_diff_day.csv', index=False, encoding='utf-8')
    shop_features = pd.merge(shop_features, s_b2_diff_day, on='shop_id', how='left').fillna(0)

    # (6)店铺评论
    Path = '../data/features/features_test/s_comments_counts.csv'
    if os.path.exists(Path):
        ...
        userSub.rename(
            ...
            inplace=True)
        # userSub.to_csv('../data/features/features_test/s_comments_counts.csv', index=False, encoding='utf-8')
    ...
    # (7)店铺信息
    Path = '../data/features/features_test/shop_info.csv'
    if os.path.exists(Path):
        ...
        # shop_info.to_csv('../data/features/features_test/shop_info.csv', index=False, encoding='utf-8')
    shop_features = pd.merge(shop_features, shop_info, on='shop_id', how='left').fillna(0)

    filePath = '../data/features/features_test/shop_features.csv'
...
def get_user_cate_features():
    ...
    Path = '../data/features/features_test/uc_bi_last_day.csv'
    if os.path.exists(Path):
        ...
        # uc_bi_last_day.to_csv('../data/features/features_test/uc_bi_last_day.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/uc_b2_diff_day.csv'
    if os.path.exists(Path):
        ...
        # uc_b2_diff_day.to_csv('../data/features/features_test/uc_b2_diff_day.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/uc_b_count_in_n.csv'
    if os.path.exists(Path):
        ...
        # uc_b_count_in_n.to_csv('../data/features/features_test/uc_b_count_in_n.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/uc_bi_count_in_n.csv'
    if os.path.exists(Path):
        ...
        # uc_bi_count_in_n.to_csv('../data/features/features_test/uc_bi_count_in_n.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/uc_b_count_rank_in_n_in_u.csv'
    if os.path.exists(Path):
        ...
        uc_b_count_rank_in_n_in_u = pd.merge(uc_b_count_rank_in_n_in_u, uc_b_count_rank_in_1_in_u, how='left',
                                             on=['user_id', 'cate']).fillna(1000)
        # uc_b_count_rank_in_n_in_u.to_csv('../data/features/features_test/uc_b_count_rank_in_n_in_u.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/uc_b2_rate.csv'
    if os.path.exists(Path):
        ...
        # uc_b2_rate.to_csv('../data/features/features_test/uc_b2_rate.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/uc_active_days.csv'
    if os.path.exists(Path):
        ...
        # uc_active_days.to_csv('../data/features/features_test/uc_active_days.csv', index=False, encoding='utf-8')
    user_cate_features = pd.merge(user_cate_features, uc_active_days, on=['user_id', 'cate'], how='left').fillna(0)
    print('uc_active_days')
    filePath = '../data/features/features_test/user_cate_features.csv'
...
def get_user_shop_features():
    ...
    Path = '../data/features/features_test/us_bi_last_day.csv'
    if os.path.exists(Path):
        ...
        # us_bi_last_day.to_csv('../data/features/features_test/us_bi_last_day.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/us_b2_diff_day.csv'
    if os.path.exists(Path):
        ...
        # us_b2_diff_day.to_csv('../data/features/features_test/us_b2_diff_day.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/us_b_count_in_n.csv'
    if os.path.exists(Path):
        ...
        # us_b_count_in_n.to_csv('../data/features/features_test/us_b_count_in_n.csv', index=False, encoding='utf-8')
    ...
    # 反映了user_id -item_category的各项操作的活跃度，对应着user_id -item_category的购买习惯)
    Path = '../data/features/features_test/us_bi_count_in_n.csv'
    if os.path.exists(Path):
        ...
        # us_bi_count_in_n.to_csv('../data/features/features_test/us_bi_count_in_n.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/us_b_count_rank_in_n_in_u.csv'
    if os.path.exists(Path):
        ...
        us_b_count_rank_in_n_in_u = pd.merge(us_b_count_rank_in_n_in_u, us_b_count_rank_in_1_in_u, how='left',
                                             on=['user_id', 'shop_id']).fillna(1000)
        # us_b_count_rank_in_n_in_u.to_csv('../data/features/features_test/us_b_count_rank_in_n_in_u.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/us_b2_rate.csv'
    if os.path.exists(Path):
        ...
        # print(c_b2_rate.info())
        # print(c_b2_rate.head())
        # us_b2_rate.to_csv('../data/features/features_test/us_b2_rate.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/us_active_days.csv'
    if os.path.exists(Path):
        ...
        # us_active_days.to_csv('../data/features/features_test/us_active_days.csv', index=False, encoding='utf-8')
    user_shop_features = pd.merge(user_shop_features, us_active_days, on=['user_id', 'shop_id'], how='left').fillna(0)

    filePath = '../data/features/features_test/user_shop_features.csv'
...
def get_cate_shop_features():
    ...
    Path = '../data/features/features_test/cs_u_rank_in_s.csv'
    if os.path.exists(Path):
        ...
        # cs_u_rank_in_s.to_csv('../data/features/features_test/cs_u_rank_in_s.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/cs_item_count.csv'
    if os.path.exists(Path):
        ...
        # cs_item_count.to_csv('../data/features/features_test/cs_item_count.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/cs_new_item_count.csv'
    if os.path.exists(Path):
        ...
        # cs_new_item_count.to_csv('../data/features/features_test/cs_new_item_count.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/cs_b2_count.csv'
    if os.path.exists(Path):
        ...
        # cs_b2_count.to_csv('../data/features/features_test/cs_b2_count.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/cs_b_rank_in_s.csv'
    if os.path.exists(Path):
        ...
        # print(userSub.head(30))
        userSub.drop(['b_count'], axis=1, inplace=True)
        # userSub.to_csv('../data/features/features_test/cs_b_rank_in_s.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/cs_b2_rank_in_s.csv'
    if os.path.exists(Path):
        ...
        userSub.drop('type_2', axis=1, inplace=True)
        # userSub.to_csv('../data/features/features_test/cs_b2_rank_in_s.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/cs_b2_rate.csv'
    if os.path.exists(Path):
        ...
        # cs_b2_rate.to_csv('../data/features/features_test/cs_b2_rate.csv', index=False, encoding='utf-8')
    ...
    Path = '../data/features/features_test/cs_active_days.csv'
    if os.path.exists(Path):
        ...
        # cs_active_days.to_csv('../data/features/features_test/cs_active_days.csv', index=False, encoding='utf-8')
    cate_shop_features = pd.merge(cate_shop_features, cs_active_days, on=['cate', 'shop_id'], how='left').fillna(0)

    # (6)是否是主营品类
    Path = '../data/features/features_test/cs_major_cate.csv'
    if os.path.exists(Path):
        ...
        # cs_major_cate.to_csv('../data/features/features_test/cs_major_cate.csv', index=False, encoding='utf-8')
    cate_shop_features = pd.merge(cate_shop_features, cs_major_cate, on=['cate', 'shop_id'], how='left').fillna(0)

    filePath = '../data/features/features_test/cate_shop_features.csv'
